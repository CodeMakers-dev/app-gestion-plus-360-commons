...
@Data
@Entity
@Table(name = "archivo_mensaje", schema = "public")
@EntityListeners(AuditingEntityListener.class)
public class ArchivoMensajeEntity implements Serializable{
	...
	@ManyToOne
	@JoinColumn(name = "id_mensaje_masivo", referencedColumnName = "id")
	private MensajeMasivoEntity mensajeMasivo;
